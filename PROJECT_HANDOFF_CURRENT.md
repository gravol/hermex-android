...
**Last updated:** 2026-08-25 — realigned with GitHub (was documenting v0.1.141; current is v0.1.150)
**Current version:** v0.1.150 (versionCode 151)
**HEAD commit:** `b9bd687` (v0.1.150 — uniform selector buttons + model filter dropdown for Insights)
**Branch:** `master`  
